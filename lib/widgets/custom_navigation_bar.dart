      ...
      child: Row(
        ...
        children: [
          IconButton(
            ...
            icon: const Icon(Icons.home, size: 30, color: Color(0xff2d2e23),),
          ),
          IconButton(
            onPressed: (){},
          ...
          IconButton(
            ...
            icon: const Icon(Icons.view_module_rounded, size: 30, color: Color(0xff002b36),),
          ),
          IconButton(
            onPressed: (){Navigator.pushReplacementNamed(context, "/profile");},
            icon: const Icon(Icons.person, size: 30, color: Color(0xff002b36),),
          ),
        ],
      ),
    );
